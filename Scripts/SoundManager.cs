...
namespace AudioSystem
{
    public class SoundManager : PersistentSingleton<SoundManager>
    {
        ...
        {
            return soundEmitterPool.GetItem();
        }

        public void ReturnToPool(SoundEmitter soundEmitter)
        {
            soundEmitterPool.ReleaseItem(soundEmitter);
        }
        ...
        void InitializePool()
        {
            soundEmitterPool = new ObjectPool<SoundEmitter>.Builder()
                .CreateFactory(CreateSoundEmitter)
                .WhenGetItem(OnTakeFromPool)
                .WhenItemReturned(OnReturnedToPool)
                .WhenItemDisposed(OnDestroyPoolObject)
                .WithStartingCapacity(defaultCapacity)
                .WithMaxCapacity(maxPoolSize)
                .Build();
        }
